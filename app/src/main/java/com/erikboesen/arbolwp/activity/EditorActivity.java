...
import com.erikboesen.arbolwp.activity.PreviewActivity;
import com.erikboesen.arbolwp.app.ArboApp;
import com.erikboesen.arbolwp.database.Theme;
import com.erikboesen.arbolwp.widget.ThemeView;
...
public class EditorActivity extends AppCompatActivity {
	...
	public void onCreate(Bundle state) {
		...
		if (intent != null &&
				...
				(theme = ArboApp.db.getTheme(themeId)) != null) {
			setTheme(theme);
		} else {
			finish();
		}
	...
	public void onPause() {
		super.onPause();
		if (themeId > -1) {
			ArboApp.db.updateTheme(themeId, getNewTheme());
		}
	}
