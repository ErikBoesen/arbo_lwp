package com.erikboesen.arbolwp.graphics;
...
public class ArboRenderer {
	...
	private boolean init() {
		...
		if (!sizeUpdate && theme.Arbo[0] != null) {
			return true;
		}
		sizeUpdate = false;
